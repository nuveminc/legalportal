...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', '$modal', 'BASE_PATH',
	function(taRegisterTool, $window, taTranslations, taSelection, $modal, BASE_PATH){
	taRegisterTool("html", {
	...
	taRegisterTool('insertImage', {
		...
		action: function(){
			// var imageLink;
			// console.log('overriding the default image action: %o', $scope.imageInput);
			// imageLink = $window.prompt(taTranslations.insertImage.dialogPrompt, '');
			// if(imageLink && imageLink !== '' && imageLink !== 'http://'){
			// 	return this.$editor().wrapSelection('insertImage', imageLink, true);
			// }
			var templateUrl = BASE_PATH.modulesUrl + 'blog/modals/image.modal.html',
				controllerName = 'imageModalController',
				item = [];
			$modal.open({
				...
				keyboard: false
			}).result.then(function (editor) {
				return	function (file) {
					// save item
					console.log('insert image: %o', file);
					return editor().wrapSelection('insertImage', file, true);
				}
